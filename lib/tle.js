class TLE {
  ...
  parse( value ) {
    ...
    this.epochYear = TLE.parseFloat( line.substring( 18, 20 ) )
    this.epochDay = TLE.parseFloat( line.substring( 20, 33 ) )
    ...
    this.checksum1 = parseInt( line.substring( 68 ), 10 )
    ...
    this.checksum2 = parseInt( line.substring( 68 ), 10 )
